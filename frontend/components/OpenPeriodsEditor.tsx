...
export default function OpenPeriodsEditor({
  ...
  return (
    <div className="mb-6">
      ...
      <div className="border border-gray-300 rounded-lg bg-white p-4 min-h-[60px]">
        {periods.length === 0 ? (
        ...
        <button
          type="button"
          onClick={handleAdd}
          className="mt-3 inline-flex items-center gap-2 px-4 py-2 rounded-full bg-brand text-white text-sm hover:bg-brand-dark transition"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="h-4 w-4"
